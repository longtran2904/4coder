...
TokenCppKind_Identifier = 160,
TokenCppKind_PPInclude = 161,
TokenCppKind_PPVersion = 162,
TokenCppKind_PPDefine = 163,
TokenCppKind_PPUndef = 164,
TokenCppKind_PPIf = 165,
TokenCppKind_PPIfDef = 166,
TokenCppKind_PPIfNDef = 167,
TokenCppKind_PPElse = 168,
TokenCppKind_PPElIf = 169,
TokenCppKind_PPEndIf = 170,
TokenCppKind_PPError = 171,
TokenCppKind_PPImport = 172,
TokenCppKind_PPUsing = 173,
TokenCppKind_PPLine = 174,
TokenCppKind_PPPragma = 175,
TokenCppKind_PPUnknown = 176,
TokenCppKind_PPDefined = 177,
TokenCppKind_COUNT = 178,
};
