...
#define LIST_SUBSTR(name) long_list_all_substring_locations_##name
        ...
        Bind(LIST_SUBSTR(case_insensitive),                              KeyCode_F, KeyCode_Alt);
        Bind(LIST       (current_buffer),                                KeyCode_F, KeyCode_Alt, KeyCode_Shift, KeyCode_Control);
        Bind(LIST_SUBSTR(case_insensitive_current_buffer),               KeyCode_F, KeyCode_Alt, KeyCode_Control);
        Bind(LIST       (of_identifier),                                 KeyCode_T, KeyCode_Alt, KeyCode_Shift);
        Bind(LIST_SUBSTR(of_identifier_case_insensitive),                KeyCode_T, KeyCode_Alt);
        Bind(LIST       (of_identifier_current_buffer),                  KeyCode_T, KeyCode_Alt, KeyCode_Shift, KeyCode_Control);
        Bind(LIST_SUBSTR(of_identifier_case_insensitive_current_buffer), KeyCode_T, KeyCode_Alt, KeyCode_Control);
#undef LIST
#undef LIST_SUBSTR
...
function void Long_Binding_MultiCursor()
{
    //~ NOTE(long): Essential
    {
        ...
        //- Cursor/Mark
        MC_register(click_set_cursor,                MC_Command_Global);
        MC_register(click_set_cursor_and_mark,       MC_Command_Global);
        MC_register(click_set_cursor_if_lbutton,     MC_Command_Global);
...
#undef LIST_SUBSTR
        ...
        //- Index
        MC_register(long_code_peek,                        MC_Command_Global);
