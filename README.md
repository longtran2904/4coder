...
### Theme Lister
Smoothly switch between themes with `long_theme_lister`. Automatically hot-reloads on saving a theme file and refreshes its associated color table. This is also where the earlier hex coloring feature really shines.
...
### Token Occurrences
Highlights all occurrences of the identifier under the cursor. You can also easily move between them using `long_move_up/down_token_occurrence`.
